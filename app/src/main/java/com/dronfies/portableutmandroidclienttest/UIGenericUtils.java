...
public class UIGenericUtils {
    ...
    public static AlertDialog ShowAlert(Context context, String title, String message, DialogInterface.OnDismissListener onDismissListener){
    ...
    //show an alert with the warning icon next to the title
    public static void ShowWarningAlertWithOkButton(Context context, String title, String message, String okButtonText, OnClickListener okButtonListener){
        ShowAlertWithOkCancelButtonsAndIcon(context, title, message, okButtonText, okButtonListener, null, null, android.R.drawable.ic_dialog_alert);
    }

    //show an alert with the warning icon next to the title
    public static void ShowWarningAlertWithOkButton(Context context, String title, String message, String okButtonText){
        ShowAlertWithOkCancelButtonsAndIcon(context, title, message, okButtonText, null, null, null, android.R.drawable.ic_dialog_alert);
    }
